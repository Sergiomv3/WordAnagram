...
public class Main {
    ...
    static List<String> listAnagrams = new LinkedList<>();
    static int lenghtOriginalWord;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner file = new Scanner(new File("src/main/java/anagramDic.txt"));
    ...
    public static void recursiveAnagrammer(String lastWordIndexed, Map<String, List<String>> lastDictionary) {
